...
void BME280_I2C::readTemperature(void)
{
   ...
   var1 = ((((adc_T >> 3) - ((int32_t)cal_data.dig_T1 << 1))) *
           ...
           ((int32_t)cal_data.dig_T2)) >>
          11;

   var2 = (((((adc_T >> 4) - ((int32_t)cal_data.dig_T1)) *

             ((adc_T >> 4) - ((int32_t)cal_data.dig_T1))) >>
            12) *

           ((int32_t)cal_data.dig_T3)) >>
          14;
...
void BME280_I2C::readHumidity(void)
{
   ...
   v_x1_u32r = (((((adc_H << 14) - (((int32_t)cal_data.dig_H4) << 20) -
                   ...
                   (((int32_t)cal_data.dig_H5) * v_x1_u32r)) +
                  ((int32_t)16384)) >>
                 15) *

                (((((((v_x1_u32r * ((int32_t)cal_data.dig_H6)) >> 10) *

                     (((v_x1_u32r * ((int32_t)cal_data.dig_H3)) >> 11) + ((int32_t)32768))) >>
                    10) +

                   ((int32_t)2097152)) *
                      ((int32_t)cal_data.dig_H2) +
                  8192) >>
                 14));

   v_x1_u32r = (v_x1_u32r - (((((v_x1_u32r >> 15) * (v_x1_u32r >> 15)) >> 7) *

                              ((int32_t)cal_data.dig_H1)) >>
                             4));
...
int16_t BME280_I2C::readS16(uint8_t reg)
{
   return (int16_t)read16(reg);
}

int16_t BME280_I2C::readS16_LE(uint8_t reg)
{
...
uint16_t BME280_I2C::read16_LE(uint8_t reg)
{
